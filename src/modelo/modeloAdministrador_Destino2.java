...
public class modeloAdministrador_Destino2 {
    ...
    public DefaultTableModel Actividad(){
        try{
            ...
            try{
                ...
                ResultSet rs = s.executeQuery("select idActividad, nombre, descripcion from actividad;");
                //PARA ESTABLECER EL MODELO AL JTABLE
    ...
    public DefaultTableModel Comentarios(String destinoId){
        try{
            //PARA ABRIR A LA BASE DE DATOS
            Connection con = conexion.abrirConexion();
            //PARA GENERAR CONSULTAS
            ...
            try{
                //EJECUTAR LA CONSULTA
                ResultSet rs = s.executeQuery("select comentario, calificacion from comentarios where Destino_idDestino="+ destinoId + ";");
                //PARA ESTABLECER EL MODELO AL JTABLE
                modelo = new DefaultTableModel();
                //OBTENIENDO LA INFORMACION DE LAS COLUMNAS
                //QUE ESTAN SIENDO CONSULTADAS
